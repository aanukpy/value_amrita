...
import { faSearch, faBell, faEnvelope, faCog, faTimes } from '@fortawesome/free-solid-svg-icons';
import "./Topnav.css";
                                ...
                                <div>
                                    ...
                                    <div className="theme-options">
                                        <div>
                                            ...
                                            <label htmlFor="lightTheme" style={{color:"white"}}>Light</label>
                                        </div>
                                        <div>
                                            <input type="radio" id="darkTheme" name="theme" value="dark" />
                                            <label htmlFor="darkTheme" style={{color:"white"}}>Dark</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
